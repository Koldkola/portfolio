...
function simpleBotReply(msg) {
  ...
  if (lower.includes('what year is it')) return "The year is 2025.";
  if (lower.includes('who is kenechi')) return "Kenechi is a software developer and the creator of this site, currently studying Information Technology/Cybersecurity.";
